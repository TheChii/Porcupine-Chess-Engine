...
//!
//! Polyglot uses specific random numbers for Zobrist hashing that differ from
...
/// Layout: [piece_type * 128 + color * 64 + square] for pieces
/// Then: castle[4], enpassant[8], turn
///
/// Total: 781 entries
/// - Pieces: 12 * 64 = 768 (indexed as piece_type * 2 + color)*64 + square)
/// - Castle: 4 (WK, WQ, BK, BQ)
/// - EnPassant: 8 (files A-H)
/// - Turn: 1
...
const RANDOM64: [u64; 781] = [
    ...
    // Castle [768..772] - WK, WQ, BK, BQ
    0x31D71DCE64B2C310, 0xF165B587DF898190, 0xA57E6339DD2CF3A0, 0x1EF6E6DBB1961EC9,
    // EnPassant [772..780] - Files A-H
    0x70CC73D90BC26E24, 0xE21A6B35DF0C3AD7, 0x003A93D8B2806962, 0x1C99DED33CB890A1,
    0xCF3145DE0ADD4289, 0xD0E4427A5514FB72, 0x77C621CC9FB3A483, 0x67A34DAC4356550B,
    // Turn [780] - side to move is white
    0xF8D626AAAF278509,
];

/// Calculate Polyglot Zobrist hash for a board position.
/// This uses the exact same random numbers as the original Polyglot implementation.
...
/// Get the Zobrist key for a piece at a square
fn piece_key(piece: Piece, color: Color, sq: Square) -> u64 {
    // Polyglot piece order: pawn=0, knight=1, bishop=2, rook=3, queen=4, king=5
    // Each piece type has 128 entries: 64 for black, 64 for white
