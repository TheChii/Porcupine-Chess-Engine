        ...
        unsafe {
            ...
            while i + 32 <= SIZE {
                ...
                let (clamped0, clamped1) = if scale == 0 {
                    ...
                    (
                        _mm256_max_epi16(
                            _mm256_min_epi16(_mm256_sra_epi16(v0, shift_amt), max_vec),
                            min_vec,
                        ),
                        _mm256_max_epi16(
                            _mm256_min_epi16(_mm256_sra_epi16(v1, shift_amt), max_vec),
                            min_vec,
                        ),
                    )
                };
            ...
            if i + 16 <= SIZE {
                ...
                let clamped = if scale == 0 {
                    ...
                    let shift_amt = _mm_cvtsi32_si128(scale as i32);
                    _mm256_max_epi16(
                        _mm256_min_epi16(_mm256_sra_epi16(v, shift_amt), max_vec),
                        min_vec,
                    )
                };
